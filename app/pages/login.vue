<template>
  <div class="relative min-h-screen bg-[--color-surface-page] lg:grid lg:grid-cols-2">
    ...
    >
      ...
      <!-- Decorative paw -->
      <div class="absolute bottom-6 right-6 text-9xl opacity-10 select-none pointer-events-none leading-none">
        🐾
      </div>
    </div>
      ...
      <div class="w-full max-w-105">
        ...
        <div class="flex items-center bg-[--color-surface-card] lg:bg-[--color-surface-page] rounded-full p-1 mb-8 w-fit mx-auto">
          <button
            ...
            :class="isLogin ? 'bg-terracotta text-white shadow' : 'text-[--color-bark-light] hover:text-[--color-bark]'"
        ...
        <!-- Loyalty info box -->
        <div class="mt-6 flex items-start gap-3 p-4 rounded-xl bg-[--color-surface-card] border border-[--color-border-warm] text-sm text-[--color-bark-light]">
