...
| `app/modules/ecommerce/components/filters/ShopHeaderSearch.global.vue` (shop) reads the Core i18n key `header.search_placeholder` | §5.8 | seam 9 residue — key moves to a shop namespace with the per-layer i18n split (Phase 2) |
