...
| E6b | **F5** footer link contributions (`footerLinks[]`), `ShopHeaderSearch` own i18n key, and the last Core→Project edge (project plugin for `useBusinessSchema` or `app.vue` → project layer) | E6a | audit frontend forbidden → 0 |
